...
public class productoDerbyDAO extends abstractDAO<Producto, Integer> implements punto3{

	private static productoDerbyDAO instance = new productoDerbyDAO();

	private productoDerbyDAO() {
		this.db = this.conn.DERBY;
	}

	public static productoDerbyDAO getInstance() {
		return instance;
	}
