...
public class facturaDerbyDAO extends abstractDAO<Factura, Integer> {

	private static facturaDerbyDAO instance = new facturaDerbyDAO();

	private facturaDerbyDAO() {
		this.db = this.conn.DERBY;
	}

	public static facturaDerbyDAO getInstance() {
		return instance;
