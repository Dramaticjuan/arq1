...
public class FacturaProductoMySQLDAO extends abstractDAO<FacturaProducto, Pair<Integer, Integer>> {

	private static FacturaProductoMySQLDAO instance = new FacturaProductoMySQLDAO();

	private FacturaProductoMySQLDAO() {
		this.db = this.conn.MYSQL;
	}

	public static FacturaProductoMySQLDAO getInstance() {
		return instance;
	}
